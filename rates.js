...
// Юань стол не котирует постоянно: курс называется по запросу.
//
// Выкуп ключей сюда не входит намеренно. Цену ключа на площадке держит
// маркетмейкер, и она стоит неделями — прошлая цена остаётся верной куда
// дольше, чем живёт объявление юаневого мейкера.
